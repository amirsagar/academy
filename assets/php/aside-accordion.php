	...
	<div class="accordion" id="accordion">
		...
		<section class="accordion-group">
			...
			<div class="accordion-heading">
				...
				<a href="#batman_begins" class="accordion-toogle" data-toggle="collapse" data-parent="#accordion">
					<span class="glyphicon glyphicon-info-sign"></span> Batman Begins</a>
				</div>
			</section>
			...
			<section class="accordion-group">
				...
				<div class="accordion-heading">
					...
					<a href="#dark_knight" class="accordion-toogle" data-toggle="collapse" data-parent="#accordion">
						<span class="glyphicon glyphicon-info-sign"></span> The Dark Knight</a>
					</div>
				</section>
				...
				<section class="accordion-group">
					...
					<div class="accordion-heading">
						...
						<a href="#dark_knight_rises" class="accordion-toogle" data-toggle="collapse" data-parent="#accordion">
							<span class="glyphicon glyphicon-info-sign"></span> The Dark Knight Rises</a>
						</div>
					</section>
